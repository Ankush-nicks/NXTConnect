          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
                Hear from our students and mentors about their experience with CreatorCollective.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                {
                  quote: "Being a mentor on CreatorCollective has been incredibly rewarding. I get to help others while reinforcing my own skills.",
        ...
        <section className="py-16 bg-gradient-to-r from-brand-blue to-brand-teal">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="mt-8 flex justify-center">
              <a href="/auth/register" className="bg-white text-brand-blue px-6 py-3 border border-transparent rounded-md text-base font-medium hover:bg-gray-50">
                Create Your Account
              </a>
            </div>
          </div>
